...
class BedrockMCPAgent:
    ...
    async def _init_llm(self):
        try:
            ...
            # 다른 모델 사용, 특정 회사 모델 직접 사용(클로드, gpt, gemini 등)
    ...
    def _setup_graph(self):
        ...
        # 함수 내부에 함수가 존재 -> 내부 함수, 함수 내부에서만 사용가능, 외부 사용 X
        ...
        # 시작점
        workflow.set_entry_point('agent') # llm이 1차 판단
        def 조건부함수()->str:
